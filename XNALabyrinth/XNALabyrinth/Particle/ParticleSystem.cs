...
namespace XNALabyrinth
{
    ...
    public class ParticleSystem : DrawableGameComponent
    {
        ...
        {
            Effect effect = content.Load<Effect>("Particle\\ParticleEffect");
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            if (firstActiveParticle != firstFreeParticle)
            {
                ...
                //BlendState bld = new BlendState();
                ////bld.BlendFactor = Color.White;
                //bld.ColorSourceBlend = Blend.SourceAlpha;
                //bld.ColorDestinationBlend = Blend.One;
                ////bld.AlphaBlendFunction = BlendFunction.Add;

                //device.BlendState = bld;
            ...
            bld.ColorSourceBlend = Blend.One;
            bld.ColorDestinationBlend = Blend.Zero;
