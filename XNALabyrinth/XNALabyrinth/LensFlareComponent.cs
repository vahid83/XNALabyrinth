...
namespace XNALabyrinth
{
    ...
    public class LensFlareComponent : DrawableGameComponent
    {
        ...
        public Vector3 LightDirection = Vector3.Normalize(new Vector3(-1f, -0.25f, 0.1f));
        ...
        Flare[] flares =
        {
            new Flare(-0.5f, 0.7f, new Color( 50,  25,  50), Globals.config.flarePath+"1"),
            new Flare( 0.3f, 0.4f, new Color(100, 255, 200), Globals.config.flarePath+"1"),
            new Flare( 1.2f, 1.0f, new Color(100,  50,  50), Globals.config.flarePath+"1"),
            new Flare( 1.5f, 1.5f, new Color( 50, 100,  50), Globals.config.flarePath+"1"),

            new Flare(-0.3f, 0.7f, new Color(200,  50,  50), Globals.config.flarePath+"2"),
            new Flare( 0.6f, 0.9f, new Color( 50, 100,  50), Globals.config.flarePath+"2"),
            new Flare( 0.7f, 0.4f, new Color( 50, 200, 200), Globals.config.flarePath+"2"),

            new Flare(-0.7f, 0.7f, new Color( 50, 100,  25), Globals.config.flarePath+"3"),
            new Flare( 0.0f, 0.6f, new Color( 25,  25,  25), Globals.config.flarePath+"3"),
            new Flare( 2.0f, 1.4f, new Color( 25,  50, 100), Globals.config.flarePath+"3"),
        };
        ...
        protected override void LoadContent()
        {
            ...
            glowSprite = Game.Content.Load<Texture2D>(Globals.config.glowPath);
