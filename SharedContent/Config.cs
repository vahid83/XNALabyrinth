...
namespace SharedConfig
{
    public class Configuration
    {
        ...
        public string checkpointModelPath;
        public string glowPath;
        public string flarePath;
        public string explosionTimerPath;
        public string explosionPath;
        public string ballRollingPath;
        public string ballHittingPath;
        public string neutralizationPath;
        ...
        public float[] checkpointXposition;
        public float[] checkpointZposition;
